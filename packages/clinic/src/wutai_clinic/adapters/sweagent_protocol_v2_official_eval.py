...
SWEAGENT_PROTOCOL_V2_OFFICIAL_EVAL_PHASE = "6.protocol_v2_sweagent_official_eval"
SWEAGENT_PROTOCOL_V2_OFFICIAL_EVAL_VERSION = "phase6_protocol_v2_official_eval_v1"
DEFAULT_RUN_ID = "phase6_protocol_v2_official_eval"
BOUNDARY = (
    "This package turns one Protocol v2 live pair into an outcome-backed official "
...
class SWEAgentProtocolV2OfficialEvalSpec:
    pair_dir: Path
    output_dir: Path
...
def run_sweagent_protocol_v2_official_eval(
    *,
    ...
    pair_report_path = spec.pair_dir / "protocol_v2_live_pair_report.json"
    pair_summary_path = spec.pair_dir / "protocol_v2_live_pair_summary.jsonl"
    ...
    official_report_path = spec.output_dir / "protocol_v2_official_eval_report.json"
    pair_summary_output_path = spec.output_dir / "protocol_v2_official_eval_pair_summary.jsonl"
    dual_scorecard_path = spec.output_dir / "protocol_v2_dual_scorecard.json"
    gates = {
        "protocol_v2_pair_report_exists": pair_report_path.is_file(),
        "protocol_v2_pair_ready_pending_official_eval": (
            pair_report.get("decision") == "protocol_v2_live_pair_ready_pending_official_eval"
        ...
        "protocol_v2_pair_main_attribution_eligible": (
    ...
    if not structural_passed:
        decision = "protocol_v2_official_eval_blocked"
    elif official_completed:
        decision = "protocol_v2_official_eval_outcome_label_ready"
    elif spec.run_official_eval and run_results:
        decision = "protocol_v2_official_eval_pending_or_failed"
    else:
        decision = "protocol_v2_official_eval_ready_pending_official_eval"
    ...
    report = generate_report(
        phase=SWEAGENT_PROTOCOL_V2_OFFICIAL_EVAL_PHASE,
        decision=decision,
        gate_results=gates,
        extras={
            "version": SWEAGENT_PROTOCOL_V2_OFFICIAL_EVAL_VERSION,
    ...
    manifest["version"] = SWEAGENT_PROTOCOL_V2_OFFICIAL_EVAL_VERSION
    manifest_path = spec.output_dir / "protocol_v2_official_eval_manifest.json"
...
__all__ = [
    "SWEAGENT_PROTOCOL_V2_OFFICIAL_EVAL_PHASE",
    "SWEAGENT_PROTOCOL_V2_OFFICIAL_EVAL_VERSION",
